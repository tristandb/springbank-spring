...
public class TransactionServiceTest extends TestCase {
    ...
    public void testGetAllTransactions() throws Exception {
        Assert.assertEquals(4, Iterators.size(transactionService.getAllTransactions().iterator()));
    }
    ...
    public void testMakeTransaction() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(1324, bankAccountService.getBankAccount(1).getBalance(), 0);
            Assert.assertEquals(23342, bankAccountService.getBankAccount(2).getBalance(), 0);
