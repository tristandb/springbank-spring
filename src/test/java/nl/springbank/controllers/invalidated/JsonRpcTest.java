...
public class JsonRpcTest {
    ...
    public void testThrowError() throws Exception {
        ...
        // Create a JsonRpcRequest to method "multiply" and an specific id
        JsonRpcRequest jsonRpcRequest = new JsonRpcRequest("throwsError", multiplyObject);
        ...
        this.mockMvc.perform(
                ...
                .andExpect(content().json("{\"jsonrpc\":\"2.0\",\"id\":\"1\",\"error\":{\"code\":500,\"message\":\"An unexpected error occured, see error details.\",\"data\":{\"exceptionTypeName\":\"nl.springbank.exceptions.jsonrpc.OtherError\",\"message\":\"An unexpected error occured, see error details.\"}}}"));
    }
}
